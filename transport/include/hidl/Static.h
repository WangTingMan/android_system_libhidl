...
LIBHIDL_EXPORT extern DoNotDestruct<ConcurrentMap<const ::android::hidl::base::V1_0::IBase*,
...
// returns sp<IBinder>
LIBHIDL_EXPORT BnConstructorMap& getBnConstructorMap();
...
// value function receives reinterpret_cast<void *>(static_cast<IFoo *>(foo)),
// returns sp<IBase>
LIBHIDL_EXPORT BsConstructorMap& getBsConstructorMap();
}  // namespace details
}  // namespace hardware
}  // namespace android
